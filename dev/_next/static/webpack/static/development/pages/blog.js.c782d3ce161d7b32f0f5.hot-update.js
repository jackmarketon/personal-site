...
class _default extends _react.Component {
  ...
  render() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_hero.default, {
      ...
      __self: this
    }, "Blog"), (0, _keys.default)(posts).length === 0 ? 'No Posts Available' : (0, _keys.default)(posts).map(slug => _react.default.createElement(LinkWrapper, {
      key: slug,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 61
...
//# sourceMappingURL=blog.js.c782d3ce161d7b32f0f5.hot-update.js.map